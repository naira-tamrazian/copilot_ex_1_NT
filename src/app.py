...
activities = {
    ...
    "Soccer Team": {
        ...
        "max_participants": 18,
        "participants": ["kayla@mergington.edu", "matt@mergington.edu"]
    },
    "Basketball Training": {
        "description": "Improve basketball skills and conditioning",
    ...
    "Drama Club": {
        "description": "Work on acting, stagecraft, and theater productions",
